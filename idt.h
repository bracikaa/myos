...
#include "port.h"
    ...
    //base class will know its own interrupt number
    class InterruptHandler
    {
    protected:
      uint8_t interruptNumber;
      InterruptManager* interruptManagerPointer;
      InterruptHandler(uint8_t interruptNumber, InterruptManager* interruptManagerPointer);
      ~InterruptHandler();
    ...
    class InterruptManager
    {
	  ...
	  InterruptHandler* handlers[256];
        ...
        public:
            InterruptManager(uint16_t hardwareInterruptOffset, GDT* GDT);
            ~InterruptManager();
            uint16_t HardwareInterruptOffset();
            void Activate();
            void Deactivate();
